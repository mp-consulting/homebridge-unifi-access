 ...
 *
 * These tests validate the expected shape of every event payload the plugin processes. If the UniFi Access API changes its event structure in a future firmware update,
 * these tests will detect the schema drift and fail, making it easy to identify which fields changed and update the plugin accordingly.
 *
