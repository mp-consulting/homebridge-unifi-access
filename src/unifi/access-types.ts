 ...
 *
 * access-types.ts: Type definitions for the UniFi Access API.
 */
import type { DeepPartial } from '../lib/util.js';
 ...
 *
 * @remarks A UniFi Access event packet is the representation of a notification event from a UniFi Access controller. The Access `event` property informs us of
 * the notification type, such as `access.data.device.remote_unlock`, for door unlock events. The details of the event are delivered as a JSON payload in the
 * `data`
 * property.
 */
