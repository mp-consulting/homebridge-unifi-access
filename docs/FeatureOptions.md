...
| <A NAME="Hub.GateDirectionDuration"></A><CODE>Hub.GateDirectionDuration<I>.Value</I></CODE>  | Duration, in seconds, of the gate direction indicator that suppresses door position sensor bounce during gate movement. Increase this value if your gate takes longer than 30 seconds to fully open or close. **(default: 30)**. <BR>*Supported on UniFi Access Gate.*
